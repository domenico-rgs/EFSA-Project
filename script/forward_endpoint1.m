...
subplot(2,3,1)
plot(x,[FPE_1 FPE_4 FPE_7])
grid on
title("FPE")
subplot(2,3,2)
plot(x,[AIC_1 AIC_4 AIC_7])
grid on
title("AIC")
subplot(2,3,3)
plot(x,[MDL_1 MDL_4 MDL_7])
grid on
title("MDL")
subplot(2,3,4)
plot(x,[SQUARED_R_1 SQUARED_R_4 SQUARED_R_7])
grid on
title("R^2")
subplot(2,3,5)
plot(x,[Cp_1 Cp_4 Cp_7])
grid on
title("C_p")
subplot(2,3,6)
plot(x,[BIC_1 BIC_4 BIC_7])
grid on
title("BIC")
